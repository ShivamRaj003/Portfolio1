    ...
    const experiences = [
        {
            ...
            achievements: [
                'Developed and deployed a full-stack web application for Attri Charitable Foundation, a live NGO website promoting social welfare',
                'Built responsive front-end interfaces and integrated APIs with secure database operations, ensuring a seamless user experience and reliable site performance'
            ]
        },
        {
